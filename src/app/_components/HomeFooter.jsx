        ...
        <>
            <section className="py-10 lg:py-20 bg-brand">
                <div className="max-w-auto mx-auto text-center  font-bold uppercase">
                    ...
                    <img src={settings?.restaurant_logo ? `${process.env.NEXT_PUBLIC_BASE_URL}/${settings?.restaurant_logo}` : "/logo-light.png"} className='h-[140px] mx-auto' onError={(e) => e.target.src = "/logo-light.png"} alt="Chim 'N' Churri " />
